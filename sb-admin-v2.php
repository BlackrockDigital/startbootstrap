...
<html lang="en">
  <head>
    ...
    <title>SB Admin 2 - Free Bootstrap Admin Theme - Free Bootstrap Template</title>
...
<?php include_once('includes/nav.php'); ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">SB Admin 2 <small>A Free Bootstrap Admin Theme</small></h1>
          <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
          <h3>Similar Templates and Themes:</h3>
        </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <a class="thumbnail" href="simple-sidebar.php" title="Simple Sidebar Template"><img src="img/simple-sidebar.jpg" alt="Bootstrap Sidebar Template"></a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <a class="thumbnail" href="bare.php" title="Bare Template"><img src="img/bare.jpg" alt="Bootstrap Starter Template"></a>
        </div>
      </div>
    </div>
