...
<head>
    ...
    <title>Start Bootstrap - Free Bootstrap Themes and Templates</title>
...
<?php include_once( 'includes/nav.php'); ?>
    ...
    <div class="masthead">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Free Bootstrap Themes and Templates</h1>
                    <h3>Built to help you get started on your next Bootstrap project.</h3>
                    <p>Templates and themes created and maintained by <a href="http://www.ironsummitmedia.com">Iron Summit Media Strategies</a>
                    </p>
                    <div class="alert alert-info alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <a href="http://designmodo.com/startup/?u=787" class="alert-link">Startup Framework</a> now is built using Bootstrap 3! When purchasing Startup Framework, use the coupon code "<strong>START</strong>" for an <strong>additional 15% off</strong>, courtesy of Start Bootstrap!
                    </div>
                    <div id="social">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 intro-marketing-box">
                    ...
                    <p>Our Bootstrap templates and themes are free to download and use, forever and ever.</p>
                </div>
                <div class="col-lg-4 col-md-4 intro-marketing-box">
                    <h2><i class="fa fa-github"></i> Open Source</h2>
                    <p>All Start Bootstrap templates are licensed under Apache 2.0 and <a href="https://github.com/ironsummitmedia/startbootstrap/">maintained on GitHub</a>.</p>
                </div>
                <div class="col-lg-4 col-md-4 intro-marketing-box">
                ...
                <div class="col-lg-4 col-md-4 intro-marketing-box">
                    ...
                    <p>These free Bootstrap templates and themes are ready to use. Download what you like and get started!</p>
                </div>
                <div class="col-lg-4 col-md-4 intro-marketing-box">
                    <h2><i class="fa fa-check"></i> Bootstrap 3 Updated</h2>
                    <p>All of our templates and themes are up to date and ready to use with Bootstrap 3!</p>
                </div>
                <div class="col-lg-4 col-md-4 intro-marketing-box">
    ...
    <div class="templates">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h2 class="page-header">Featured Templates and Themes:</h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="preview">
                        <a class="thumbnail" href="sponsored-templates.php">
                            <img src="img/sponsored/startup-framework.jpg" class="img-responsive" alt="Startup Framework - Complete Bootstrap Theme Pacakge">
                        </a>
                        <h3>Startup Framework</h3>
                        <p>A premium framework including <strong>25 bootstrap templates</strong>.</p>
                        <div class="btn-group"><a class="btn btn-default" href="sponsored-templates.php">Preview &amp; Buy</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="preview">
                        <a target="_blank" class="thumbnail" href="http://designmodo.github.io/startup-demo/?u=787">
                            <img src="img/sponsored/designmodo-1.jpg" class="img-responsive" alt="Free Bootstrap Theme Sample by Designmodo">
                        </a>
                        <h3>Free Demo Template #1</h3>
                        <p>A free Demo Version of the Startup Framework by Designmodo.</p>
                        <div class="btn-group"><a target="_blank" class="btn btn-default" href="http://designmodo.github.io/startup-demo/?u=787">Preview &amp; Download</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="preview">
                        <a target="_blank" class="thumbnail" href="http://designmodo.github.io/startup-demo/?u=787">
                            <img src="img/sponsored/designmodo-2.jpg" class="img-responsive" alt="Free Bootstrap Template Sample by Designmodo">
                        </a>
                        <h3>Free Demo Template #1</h3>
                        <p>A free Demo Version of the Startup Framework by Designmodo.</p>
                        <div class="btn-group"><a target="_blank" class="btn btn-default" href="http://designmodo.github.io/startup-demo/?u=787">Preview &amp; Download</a>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <a class="btn btn-primary btn-block btn-lg" href="sponsored-templates.php">View Premium Bootstrap Templates</a>
                </div>
            </div>
